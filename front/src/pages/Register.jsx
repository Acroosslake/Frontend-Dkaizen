...
function Register() {
  ...
  // 👁️ NUEVOS ESTADOS PARA MOSTRAR/OCULTAR CONTRASEÑAS
                ...
                <div>
                  ...
                  <div className="relative">
                    <input 
                      ...
                      className="w-full px-5 py-3.5 pr-10 bg-[#111] border border-gray-800 rounded-2xl focus:outline-none focus:border-dk-gold text-sm text-white transition-all" 
                      placeholder="••••••••" 
                    />
                    <button 
                      type="button" 
                      onClick={() => setShowPassword(!showPassword)}
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-dk-gold transition-colors focus:outline-none"
                    >
                      {showPassword ? (
