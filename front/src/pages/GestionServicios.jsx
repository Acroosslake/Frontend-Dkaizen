        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-16 gap-8">
          ...
          >
            <button 
              ...
              className="group flex items-center justify-center w-12 h-12 rounded-full border border-gray-800 bg-black/50 hover:border-dk-gold transition-all duration-500"
            >
            ...
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-light">
                Gestión de <span className="font-vogue text-dk-gold italic">Cortes</span>
              </h1>
            </div>
          </motion.div>
          ...
          {services.map((s, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-gray-500 line-clamp-2 mb-8 leading-relaxed h-10">
                  {s.description || 'Experiencia completa de barbería con los más altos estándares de calidad.'}
                </p>
                ...
                <div className="flex items-end justify-between border-t border-gray-900 pt-6">
                  ...
                  <div className="flex gap-2">
                    <button 
                      ...
                      className="p-3 bg-gray-900/50 rounded-xl text-gray-400 hover:text-dk-gold hover:bg-dk-gold/10 transition-all"
                      title="Editar"
                    >
                      ✎
                    </button>
                    <button 
                      ...
                      className="p-3 bg-gray-900/50 rounded-xl text-gray-400 hover:text-red-500 hover:bg-red-500/10 transition-all"
                      title="Eliminar"
                    >
                      ✕
                    </button>
        ...
        {showModal && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative bg-[#0a0a0a] border border-gray-800 p-8 md:p-12 rounded-[3rem] w-full max-w-lg shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden"
            >
              {/* Acento lateral */}
              <div className="absolute top-0 left-0 w-2 h-full bg-dk-gold shadow-[0_0_20px_rgba(212,175,55,0.3)]"></div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label className="text-[10px] text-gray-500 uppercase font-black ml-4 mb-2 block">Nombre del Combo</label>
                  <input 
                    type="text" required
                    className="w-full bg-black/50 border border-gray-900 p-4 rounded-2xl text-sm outline-none focus:border-dk-gold transition-all"
                    value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})}
                  />
                </div>

                <div>
                  <label className="text-[10px] text-gray-500 uppercase font-black ml-4 mb-2 block">Descripción Detallada</label>
                  <textarea 
                    rows="3"
                    className="w-full bg-black/50 border border-gray-900 p-4 rounded-2xl text-sm outline-none focus:border-dk-gold transition-all"
                ...
                <button 
                  type="submit"
                  className="w-full bg-dk-gold text-black py-5 rounded-2xl text-[11px] font-black uppercase tracking-widest mt-6 hover:bg-white transition-all shadow-xl"
                >
